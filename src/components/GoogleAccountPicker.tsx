        ...
        >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">to continue to Vault</p>
                </div>
              </div>
              <button
                onClick={onClose}
          ...
          <div className="py-2">
            {accounts.map((account, index) => (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center">
                  <span className="text-sm font-medium text-primary">{account.avatar}</span>
                </div>
            ...
            <motion.button
              ...
              onClick={onClose}
              className="w-full flex items-center gap-4 px-6 py-4 hover:bg-secondary/50 transition-colors text-left border-t border-border"
            >
          ...
          <div className="px-6 py-4 border-t border-border bg-muted/30">
            <p className="text-xs text-muted-foreground text-center">
              To continue, Google will share your name, email address, and profile picture with Vault.
            </p>
          </div>
        </motion.div>
      </motion.div>
